/*global createState, createMove, rules, QUnit, WHITE_ROOK, WHITE_KNIGHT,
        WHITE_BISHOP, WHITE_QUEEN, WHITE_KING, WHITE_PAWN, BLACK_PAWN,
        BLACK_QUEEN, EMPTY, BLACK_KNIGHT, BLACK_BISHOP */
...
QUnit.test("a pawn may not advance two steps through a piece", function (assert) {
    var state = initializeWithMoves([
        [[6, 0], [4, 0]],
